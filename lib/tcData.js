// ─────────────────────────────────────────────────────────────
// Talent Compass AI — 가상 샘플 데이터 (전원 가상 인물, 실명·실기업 아님)
...
export const TEAM_INIT = [
  { slot: "PM", id: "E06", why: "공공 대형 프로젝트 PM 2회, PMP 보유", gap: "—" },
  { slot: "백엔드 개발자", id: "E01", why: "요구 스택 전부 보유, 공공 경험·SQLD", gap: "—" },
  { slot: "백엔드 개발자", id: "E02", why: "대용량 처리·클라우드 전환 경험", gap: "데이터 모델링 심화" },
  { slot: "데이터 담당자", id: "E05", why: "DW 구축·공공데이터 파이프라인 경험", gap: "—" },
  { slot: "AI 담당자", id: "E11", why: "AI API 서비스화 경험, 공공 AI 서비스 이력", gap: "—" },
